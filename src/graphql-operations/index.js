...
export const INSERT_USER = gql`
    mutation InsertOneUser($email: String = "", $lastname1: String = "", $lastname2: String = "", $name: String = "", $password: String = "", $description: String = "") {
        insert_users_one(
            object: {
                email: $email,
                lastname1: $lastname1,
...
export const INSERT_ONE_EVALUATION = gql`
    mutation InsertOneEvaluation($date: timestamp = "", $evaluated_user_id: Int = 10, $evaluating_user_id: Int = 10, $result: Int = 10, $softskill_id: Int = 10) {
        insert_evaluations_one(object: {date: $date, evaluated_user_id: $evaluated_user_id, evaluating_user_id: $evaluating_user_id, result: $result, softskill_id: $softskill_id}) {
            evaluation_id
        }
    }
`
...
export const UPDATE_PROFILE_DESCRIPTION = gql`
    mutation UpdateProfileDescription($user_id: Int = 10, $description: String = "") {
        update_profiles(where: {user_id: {_eq: $user_id}}, _set: {description: $description}) {
            affected_rows
            returning {
                description
            }
...
export const UPDATE_PROFILE_AVATAR = gql`
    mutation UpdateUserAvatar($avatar: String = "", $user_id: Int = 10) {
        update_users_by_pk(pk_columns: {user_id: $user_id}, _set: {avatar: $avatar}) {
            avatar
        }
    }
`