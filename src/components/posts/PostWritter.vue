    ...
    <div class="card-body">
      ...
      <form @submit.prevent="onPost">
        <div class="mb-3">
          ...
          <input v-model="title" type="text" class="form-control" id="post-title" placeholder="Titulo de la publicacion">
        </div>
        <div class="mb-3">
          <label for="post-description" class="form-label">Descripcion</label>
          <textarea v-model="description" class="form-control" id="post-description" rows="3" placeholder="Descripcion de la publicacion"></textarea>
        </div>
